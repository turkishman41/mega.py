...
│
├<b>✅ **Done** : `{humanize.naturalsize(file_info.st_size)}`</b>
│
├<b>🗂 **Total** : `{humanize.naturalsize(file_size)}</b>
│
├<b>📥 {progress}</b>
│
╰─────────[😊]──────⍟""", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Cancel Mega DL", callback_data="cancel_mega")]]))
